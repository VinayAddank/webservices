...
public class PermanentAddressEntity extends BaseEntity {
    /**
     * 
     */
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "p_address_seq")
    @SequenceGenerator(name = "p_address_seq", sequenceName = "p_address_seq", allocationSize = 1)
