...
public class Data {
	...
	public String toString() {
		return "Data [rtoCode=" + rtoCode + ", rtoName=" + rtoName + ", affixationCenterCode=" + affixationCenterCode
				+ ", transactionNo=" + transactionNo + ", transactionDate=" + transactionDate + ", authorizationRefNo="
				+ authorizationRefNo + ", authorizationDate=" + authorizationDate + ", engineNo=" + engineNo
				+ ", chassisNo=" + chassisNo + ", prNumber=" + prNumber + ", ownerName=" + ownerName + ", ownerAddress="
				+ ownerAddress + ", ownerEmailId=" + ownerEmailId + ", ownerPinCode=" + ownerPinCode + ", mobileNo="
				+ mobileNo + ", vehicleType=" + vehicleType + ", transType=" + transType + ", vehicleClassType="
				+ vehicleClassType + ", mfrsName=" + mfrsName + ", modelName=" + modelName + ", hsrpFee=" + hsrpFee
				+ ", oldNewFlag=" + oldNewFlag + ", govtVehicleTag=" + govtVehicleTag + ", timeStamp=" + timeStamp
				+ ", trNumber=" + trNumber + ", dealerName=" + dealerName + ", dealerMail=" + dealerMail
				+ ", dealerRtoCode=" + dealerRtoCode + ", regDate=" + regDate + "]";
	}
