...
/**
 * The primary key class for the susp_drivers_license_dtls database table.
 * 
 */
@Embeddable
public class SuspDriversLicenseDtlPK implements Serializable {
    ...
    public SuspDriversLicenseDtlPK() {}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SuspDriversLicenseDtlPK)) {
			return false;
		}
		SuspDriversLicenseDtlPK castOther = (SuspDriversLicenseDtlPK)other;
		return 
